...
import { Search, TrendingUp, CheckCircle, XCircle, Clock, ArrowLeft } from "lucide-react"
...
export default function PatternsPage() {
    ...
    const [filteredPatterns, setFilteredPatterns] = useState<DetectedFieldPattern[]>([])
        ...
        <div className="min-h-screen bg-background p-6">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-foreground">Gestion des Patterns</h1>
                        <p className="text-sm text-muted-foreground">
                            Gérez les patterns détectés pour améliorer l'extraction automatique
                        </p>
                    </div>
                </div>
            </div>
            ...
            {statistics && (
                <div className="grid gap-4 md:grid-cols-4 mb-6">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{statistics.totalPatterns}</div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{statistics.pendingPatterns}</div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{statistics.approvedPatterns}</div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{statistics.approvalRate.toFixed(0)}%</div>
                        </CardContent>
                    </Card>
                </div>
            )}
