...
export default function BankListPage() {
    ...
    const pendingStatements = statements.filter((s) =>
        !["VALIDATED", "VALIDE", "COMPTABILISE", "COMPTABILISÉ"].includes(s.status)
    )
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                {pendingStatements.length} relevé{pendingStatements.length > 1 ? "s" : ""} en cours de gestion
                            </CardDescription>
                        </div>
