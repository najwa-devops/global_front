...
export async function uploadDynamicInvoice(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/upload`,
    {
      method: "POST",
      body: formData,
    },
...
export async function processDynamicInvoice(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/${id}/process`,
    {
      method: "POST",
...
export async function updateDynamicInvoiceFields(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/${id}/fields`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
export async function getAllDynamicInvoices(
  ...
  if (!response.ok) {
    ...
    console.error(
      `[API] getAllDynamicInvoices failed (${response.status}):`,
      errorMsg,
    );
...
export async function deleteDynamicInvoice(id: number): Promise<void> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/${id}`,
    { method: "DELETE" },
  );
  if (!response.ok) throw new Error(await parseApiError(response));
}
...
export async function updateInvoiceStatus(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/${id}/status`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
export async function processDynamicInvoicesBulk(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/process-bulk`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function reprocessDynamicInvoicesBulk(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/reprocess-bulk`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ invoiceIds }),
...
export async function getDynamicAvailableSignatures(id: number): Promise<any> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/${id}/available-signatures`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function linkTierToDynamicInvoice(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-invoices/${invoiceId}/link-tier`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function getTemplateById(id: number): Promise<DynamicTemplateDto> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/${id}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function createDynamicTemplate(
  request: CreateDynamicTemplateRequest,
...
export async function patchTemplate(
  id: number,
  request: UpdateDynamicTemplateRequest,
): Promise<DynamicTemplateDto> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/${id}`,
    {
...
export async function searchTemplates(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/search?name=${encodeURIComponent(name)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function getTemplatesBySupplierType(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/by-supplier-type/${encodeURIComponent(supplierType)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function getReliableTemplates(): Promise<DynamicTemplateDto[]> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/reliable`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function getTemplatesBySupplier(supplier: string): Promise<any> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/by-supplier?supplier=${encodeURIComponent(supplier)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function testTemplate(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/${templateId}/test`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function detectTemplate(ocrText: string): Promise<any> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/dynamic-templates/detect`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ ocrText }),
...
export async function getAccounts(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts?activeOnly=${activeOnly}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
...
export async function getAccountById(id: number): Promise<Account> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts/${id}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  return data.account;
...
export async function getAccountByCode(code: string): Promise<Account | null> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts/by-code/${code}`,
  );
...
export async function searchAccounts(query: string): Promise<Account[]> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts/search?query=${encodeURIComponent(query)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  return data.accounts || [];
...
export async function getAccountsByClasse(classe: number): Promise<Account[]> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts/by-classe/${classe}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  return data.accounts || [];
...
export async function getChargeAccounts(): Promise<Account[]> {
  ...
  return accounts.filter(
    (a) => a.isChargeAccount || a.classe === 6 || a.code.startsWith("6"),
  );
}
...
export async function getFournisseurAccounts(): Promise<Account[]> {
  const accounts = await getAccounts(true);
  return accounts.filter(
    (a) => a.isFournisseurAccount || a.code.startsWith("4411"),
  );
}
...
export async function activateAccount(id: number): Promise<void> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts/${id}/activate`,
    { method: "PATCH" },
  );
  if (!response.ok) throw new Error(await parseApiError(response));
}
...
export async function importAccounts(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/accounts/import`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function getAllTiers(activeOnly: boolean = true): Promise<Tier[]> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers?activeOnly=${activeOnly}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  return data.tiers || [];
...
export async function getTierByTierNumber(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers/by-tier-number/${tierNumber}`,
  );
  if (response.status === 404) return null;
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
...
export async function getTierByIce(ice: string): Promise<Tier | null> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers/search?query=${encodeURIComponent(ice)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  ...
  const exact = tiers.find(
    (t) => String(t.ice || "").replace(/\s+/g, "") === normalized,
  );
  return exact || null;
}
...
export async function getTierByIfNumber(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers/search?query=${encodeURIComponent(ifNumber)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  const tiers: Tier[] = data.tiers || [];
  ...
  const exact = tiers.find(
    (t) => String(t.ifNumber || "").replace(/\s+/g, "") === normalized,
  );
  return exact || null;
}
...
export async function searchTiers(query: string): Promise<Tier[]> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers/search?query=${encodeURIComponent(query)}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  return data.tiers || [];
...
export async function updateTier(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers/${id}`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(request),
...
export async function activateTier(id: number): Promise<void> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/accounting/tiers/${id}/activate`,
    { method: "PATCH" },
  );
  if (!response.ok) throw new Error(await parseApiError(response));
}
...
export async function createAccountingConfig(
  request: UpsertAccountingConfigRequest,
...
export async function updateAccountingConfig(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/accounting-configs/${id}`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(request),
...
export async function getAccountingConfigBanks(): Promise<string[]> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/accounting-configs/banks`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
  return data.banks || [];
...
export async function uploadBankStatement(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/upload`,
    {
      method: "POST",
      body: formData,
    },
...
export async function getBankStatementById(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/${id}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function validateBankStatement(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/${id}/validate`,
    {
      method: "POST",
...
export async function updateBankStatementStatus(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/${id}/status`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
export async function deleteAllBankStatements(): Promise<void> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/all`,
    { method: "DELETE" },
  );
  if (!response.ok) throw new Error(await parseApiError(response));
}
...
export async function getBankStatementStats(): Promise<BankStatementStats> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/stats?_t=${Date.now()}`,
    {
      cache: "no-store",
...
export async function retryFailedBankStatementPages(id: number): Promise<any> {
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/${id}/retry-failed`,
    { method: "POST" },
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
...
export async function getBankOptions(): Promise<{
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-statements/bank-options`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  return response.json();
}
...
export async function getTransactionsByStatementId(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-transactions/statement/${statementId}`,
  );
  if (!response.ok) throw new Error(await parseApiError(response));
  const data = await response.json();
...
export async function updateBankTransaction(
  ...
  const response = await apiFetch(
    `${API_BASE_URL}/api/v2/bank-transactions/${id}`,
    {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
export async function deleteDossier(id: number): Promise<void> {
  const response = await apiFetch(`${API_BASE_URL}/api/dossiers/${id}`, {
    method: "DELETE",
  });
  if (!response.ok) throw new Error(await parseApiError(response));
}
