...
export function UploadBankPage({
  onUpload,
  onViewBankStatement,
  isDemoMode,
}: UploadBankPageProps) {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        ...
        const resolved =
          await resolveBankOptionsFromAccountingConfig(allOptions);
      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <div>
            ...
            <CardDescription>
              Glissez-déposez vos relevés ou sélectionnez des fichiers
            </CardDescription>
          </div>
        </CardHeader>
            ...
            <div className="flex flex-col items-center gap-4 text-center px-6">
              ...
              <div>
                <p className="text-lg font-medium text-foreground">
                  Glissez vos relevés bancaires ici
                </p>
