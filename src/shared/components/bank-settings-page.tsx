      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm shadow-xl">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Choisissez la structure de banque par défaut pour le traitement
                OCR des relevés bancaires.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="rounded-xl border border-blue-500/20 bg-blue-500/5 p-4 flex gap-3 text-sm text-blue-600 dark:text-blue-400">
            ...
            <p>
              Ce paramétrage permet de forcer l'extracteur OCR à utiliser une
              structure spécifique. Cela est utile si la détection automatique
              échoue ou pour garantir une extraction optimale.
            </p>
          </div>

          <div className="space-y-4">
            <Label className="text-base font-semibold">
              Banques actives pour l'upload
            </Label>
      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
        <CardHeader className="py-4">
          <CardTitle className="text-lg">
            Détails des structures supportées
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground leading-relaxed">
            Chaque banque possède une structure de relevé unique (position des
            colonnes, formats de dates, mots-clés pour les soldes). L'extracteur
            OCR utilise ces modèles pour identifier précisément :
          </p>
