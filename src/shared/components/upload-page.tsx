...
export function UploadPage({ onUpload, onViewInvoice, isDemoMode }: UploadPageProps) {
    ...
    <div className="space-y-6 animate-fade-in">
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
        <CardHeader>
          ...
          <CardDescription>Glissez-deposez vos factures ou cliquez pour selectionner des fichiers</CardDescription>
        </CardHeader>
        <CardContent>
          <div
            onDrop={handleDrop}
